...
# Gemini CLI Devcontainer Feature (isolated)
# Installs the Gemini CLI without mounting any host credentials or config

echo "Installing Gemini CLI (isolated mode)..."
...
echo "Gemini CLI isolated feature installation complete."
